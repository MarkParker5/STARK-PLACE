...
async def run(manager: CommandsManager, speech_recognizer: SpeechRecognizer, speech_synthesizer: SpeechSynthesizer):
    async with asyncer.create_task_group() as main_task_group:
        ...
        voice_assistant = VoiceAssistant(
            speech_recognizer=speech_recognizer, speech_synthesizer=speech_synthesizer, commands_context=context
        )
        ...
        def add_porcupine_listener():
            ...
            main_task_group.soonify(porcupine.start)(
                access_key=access_key, keyword_paths=keyword_paths, model_path=model_path, callback=on_wake_word
            )
