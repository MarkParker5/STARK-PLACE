        ...
        match decision.response_type:
            ...
            case "immediate":
                ...
                async def _immediate_runner() -> Response:
                    return Response(response_text, voice=response_text)
            ...
            case "background":
                ...
                async def _background_runner() -> Response:
                    try:
                        ...
                        logger.debug(
                            f"AgentFallback full: confidence={full_result.output.confidence:.2f} reasoning={full_result.output.reasoning!r}"
                        )
                    except Exception as e:
                        dev_raise(e)
                        raise
